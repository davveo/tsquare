...
var file_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x22, 0x1b,
	...
	0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x49, 0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x1e,
	0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f,
	0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	...
	0x75, 0x74, 0x68, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x28, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x74, 0x72,
	...
	0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x50, 0x69, 0x6e, 0x67, 0x1a, 0x1b, 0x2e, 0x67, 0x6f,
	0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x50, 0x6f, 0x6e, 0x67, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x62, 0x06,
...
var file_proto_auth_auth_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: go.micro.service.auth.Message
	(*Request)(nil),           // 1: go.micro.service.auth.Request
	(*Response)(nil),          // 2: go.micro.service.auth.Response
	(*StreamingRequest)(nil),  // 3: go.micro.service.auth.StreamingRequest
	(*StreamingResponse)(nil), // 4: go.micro.service.auth.StreamingResponse
	(*Ping)(nil),              // 5: go.micro.service.auth.Ping
	(*Pong)(nil),              // 6: go.micro.service.auth.Pong
}
var file_proto_auth_auth_proto_depIdxs = []int32{
	1, // 0: go.micro.service.auth.Auth.Call:input_type -> go.micro.service.auth.Request
	3, // 1: go.micro.service.auth.Auth.Stream:input_type -> go.micro.service.auth.StreamingRequest
	5, // 2: go.micro.service.auth.Auth.PingPong:input_type -> go.micro.service.auth.Ping
	2, // 3: go.micro.service.auth.Auth.Call:output_type -> go.micro.service.auth.Response
	4, // 4: go.micro.service.auth.Auth.Stream:output_type -> go.micro.service.auth.StreamingResponse
	6, // 5: go.micro.service.auth.Auth.PingPong:output_type -> go.micro.service.auth.Pong

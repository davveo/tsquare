...
func (*Response) Descriptor() ([]byte, []int) {
	return file_uuid_proto_rawDescGZIP(), []int{2}
}
...
var file_uuid_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x75, 0x75, 0x69, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x15, 0x67, 0x6f,
	0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x75,
	0x75, 0x69, 0x64, 0x22, 0x21, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16,
	0x0a, 0x06, 0x6e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06,
	0x6e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x22, 0x16, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e,
	...
	0x65, 0x2e, 0x75, 0x75, 0x69, 0x64, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x32, 0x57, 0x0a, 0x04, 0x55, 0x75, 0x69, 0x64, 0x12, 0x4f, 0x0a, 0x0a, 0x47, 0x65, 0x6e,
	0x65, 0x72, 0x61, 0x74, 0x65, 0x49, 0x64, 0x12, 0x1e, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63,
	0x72, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x75, 0x75, 0x69, 0x64, 0x2e,
...
var file_uuid_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_uuid_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: go.micro.service.uuid.Request
	(*Data)(nil),     // 1: go.micro.service.uuid.Data
	(*Response)(nil), // 2: go.micro.service.uuid.Response
}
var file_uuid_proto_depIdxs = []int32{
	1, // 0: go.micro.service.uuid.Response.data:type_name -> go.micro.service.uuid.Data
	0, // 1: go.micro.service.uuid.Uuid.GenerateId:input_type -> go.micro.service.uuid.Request
	2, // 2: go.micro.service.uuid.Uuid.GenerateId:output_type -> go.micro.service.uuid.Response
...
func file_uuid_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_uuid_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
